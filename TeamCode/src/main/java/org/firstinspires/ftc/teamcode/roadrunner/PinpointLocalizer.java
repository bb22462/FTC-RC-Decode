...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -126.87092926400825; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -940.0423644301852; // x position of the perpendicular encoder (in tick units)
    }
